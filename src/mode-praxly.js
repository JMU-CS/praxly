...
var JavaScriptHighlightRules = function (options) {
    var keywordMapper = this.createKeywordMapper({
        ...
        "keyword": "const|yield|import|get|set|async|await|" +
            ...
            "if|in|of|instanceof|new|return|switch|throw|try|typeof|let|var|while|with|debugger|end|" +
...
var JavaHighlightRules = function () {
    var keywords = ("abstract|continue|for|new|switch|" +
        ...
        "var|print|and|or|not|repeat|until");
...
ace.define("ace/mode/praxly",["require","exports","module","ace/lib/oop","ace/mode/javascript","ace/mode/java_highlight_rules","ace/mode/folding/java"], function(require, exports, module){"use strict";
var oop = require("../lib/oop");
...
(function () {
    ...
    this.$id = "ace/mode/praxly";
    this.snippetFileId = "ace/snippets/java";
}).call(Mode.prototype);
exports.Mode = Mode;

});                (function() {
                    ace.require(["ace/mode/praxly"], function(m) {
